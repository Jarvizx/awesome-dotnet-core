...
* [Spin](https://www.nuget.org/packages/Spin/) CMS cross platforms based to .net core
...
* [Lamar](https://github.com/jasperfx/lamar) - Dependency Injection/Inversion of Control tool for .NET. (Previously StructureMap)
